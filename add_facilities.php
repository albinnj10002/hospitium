...
if(isset($_POST['submit']))
{
  ...
  $b="INSERT INTO `facilities`(`afl_id`, `af_ventilator`, `af_icu`, `af_ambulance`, `af_oxygen`) VALUES('$l_id','$ventilator','$icu','$ambulance','$oxygen')";
  // var_dump($b);
...
if(isset($_POST['edit']))
{
  ...
  $qu="UPDATE facilities SET af_ventilator='$ventilator',af_icu='$icu',af_ambulance='$ambulance',af_oxygen='$oxygen' where afl_id=$l_id";
  //var_dump($qu);
