            ...
            <center><div class="form-inner-cont">
              <form action="" method="post" class="" style="width: 600px; " enctype="multipart/form-data">
                ...
                <div class="form-submit text-center">
                    <button type="submit" name="login" class="btn btn-style btn-primary">Login</button><br> Or <br> <button class="btn btn-style btn-success"><a href="userreg.php">Create Account</a></button>
                  </div><br>
