  ...
  $approve=$row['l_approve'];
        ...
        <div class="col-lg-4 col-md-6 feature-grid">
          ...
          <div class="feature-body service3"><a href="#url">
            ...
            <a href="fdelete.php?fl_id=<?php echo $fl_id;?>" class="btn btn-style btn-primary">Delete</a>
            <a href="fdelete.php?fl_id=<?php echo $fl_id;?>" class="btn btn-style btn-primary">Delete</a></div>
            </div>
          </div>
