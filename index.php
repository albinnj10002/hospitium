...
<head>
  ...
  <!-- pwa -->
  <link rel="manifest" href="/hospitium/manifest.json">
  <link rel="icon" href="/hospitium/assets/images/pwaimg/favicon.ico" type="image/x-icon" />
...
<body>
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav mx-lg-auto">
                ...
                <!-- <li class="nav-item">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
                    ...
                    <a class="dropdown-item" href="userreg.php">Patient</a>
                    <a class="dropdown-item" href="facultyreg.php">Faculty</a>
              ...
              <ul class="navbar-nav search-right mt-lg-0 mt-2">
               ...
               <!--  <li class="nav-item"><a href="login.php" class="free-con btn btn-style btn-secondary d-block"
                   >Login</a> -->
                   <li class="nav-item"><a href="login.php" class="free-con btn btn-style btn-secondary d-block"
                    >Book Appointment</a>
                                  ...
                                  <div class="styled-input">
                                    ...
                                    <div class="appointment-form-field">
                                      ...
                                      <select id="doctor" required="Select Doctor">
                                        ...
                                        <option value="">Dr.Abhijith</option>
                                        <option value="">Dr.Asritha</option>
                                        <option value="">Dr.Steven Strange</option>
                                        <option value="">Dr.Bruce Banner</option>
                                        <option value="">Dr.Deus</option>
                                        <option value="">Dr.Valentino</option>
                                        <option value="">Dr.Chrome</option>
                                      </select>
                                    </div>
                                  </div>
 ...
 <!--  <section class="w3l-ab-features py-5">
    ...
    <div class="gallery-inner container py-lg-0 py-3">
      <div class="row stats-con">
        <div class="col-lg-3 col-6 stats_info counter_grid">
          ...
          <p class="counter">1928</p>
          <h4>Expert Doctors</h4>
        </div>
        <div class="col-lg-3 col-6 stats_info counter_grid1">
          <span class="fa fa-laptop"></span>
          <p class="counter">6969</p>
          <h4>Registered Users</h4>
        </div>
        <div class="col-lg-3 col-6 stats_info counter_grid mt-lg-0 mt-5">
          <span class="fa fa-smile-o"></span>
          <p class="counter">666</p>
          <h4>Happy Clients</h4>
        </div>
  ...
  <script src="/hospitium/assets/js/pwa.js"></script>
